...
### Frontend
```glob
web/src/**/*.tsx        # All React components
web/src/**/*.ts         # All TypeScript files
web/src/components/**   # Only components directory
```

### Backend Services
```glob
api/src/**/*.ts            # API service
```
